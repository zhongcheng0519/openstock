...
| 备用行情       | 用户请求时按需同步                           | Tushare bak_daily |
...
| selling        | Numeric    | 内盘（主动卖，手）             |
| buying         | Numeric    | 外盘（主动买，手）             |
...
| PUT  | /api/v1/auth/profile        | 修改个人信息       | 登录    |
